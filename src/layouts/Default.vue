  ...
  <div class="content-wrapper bg-background-primary font-sans text-copy-primary leading-normal flex flex-col min-h-screen" :class="theme">
    <header class="border-t-14 border-blue-700">
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-8">
        <div>
          <g-link v-if="theme === 'theme-light'" to="/"><span class="font-extrabold text-2xl text-blue-500">Ben Umali</span></g-link>
          <g-link v-else to="/"><span class="font-extrabold text-2xl text-white">Ben Umali</span></g-link>
        </div>
        ...
        >
          <li class="hidden mr-8 mb-6 lg:mb-0">
            <search-input />
          </li>
          ...
          <li class="mr-8 mb-6 lg:mb-0">
            <a v-if="$route.path === '/'" href="/#projects" v-scroll-to="'#projects'" class="text-copy-primary hover:text-gray-600">Work</a>
            <g-link v-else to="/#projects" class="text-copy-primary hover:text-gray-600">Work</g-link>
          </li>
          <li class="hidden mr-8 mb-6 lg:mb-0">
    ...
    <footer class="bg-blue-500 text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        <div class="mb-8 lg:mb-0">
          <div>Copyright Ben Umali {{ new Date().getFullYear() }}. All rights reserved.</div>
          <div class="hidden">
        ...
        <ul class="flex items-center">
          <li class="mr-8">
            <a href="mailto:benjoomali@gmail.com" class="text-white hover:text-gray-400">
          ...
          <li class="mr-8">
            <a href="https://github.com/benjoomali" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li class="mr-8">
            <a href="https://twitter.com/benjoomali" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://instagram.com/benjoomali" target="_blank" class="text-white hover:text-gray-400">
